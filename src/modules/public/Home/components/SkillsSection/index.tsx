        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          {SKILLS.map(({ category, skills }, categoryIndex) => (
            <motion.div
              ...
              className="p-6 rounded-2xl bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 hover:border-cyan-500/30 transition-all duration-300"
            >
              <h3 className="text-lg font-semibold mb-5 text-cyan-600 dark:text-cyan-400 flex items-center gap-2">
